 ...
 *
 * Notes:
 *   - after including this header, define LOG_LEVEL to one of this file constant :
 * LOG_LEVEL_* Example #include <logging.h> LOG_MODULE_REGISTER(app_net, LOG_LEVEL_DBG);
 *
...
int _log_print(const struct log_line *log, const char *__restrict__ fmt, ...);
