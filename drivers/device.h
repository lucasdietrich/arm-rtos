...
#define DEVICE_DATA_GET(_device, _type) ((_type *)(_device)->data)

#define DEVICE_CONFIG_GET(_device, _type) ((_type *)(_device)->config)

#define DEVICE_API_GET(_device, _type) ((const _type *)(_device)->api)
...
#define SERIAL_API_GET(_device) DEVICE_API_GET(_device, struct serial_api)
...
typedef void (*timer_callback_t)(const struct device *timer, void *user_data);
...
#define TIMER_API_GET(_device) DEVICE_API_GET(_device, struct timer_api)
